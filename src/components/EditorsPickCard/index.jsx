            ...
            <div className='w-[286px] h-[311px] flex flex-col gap-4'>
                ...
                <div className='flex items-start '>
                    ...
                    <div className='px-4 flex flex-col gap-2 w-full '>
                        ...
                        <p className='text-black text-xs font-semibold flex items-center gap-2'>Shane Doe <span className='flex items-center text-gray-400 gap-2'><TbSquareRotatedFilled className='text-[7px]' />Mar 15, 2020</span></p>
                    </div>
                </div>
            </div>
        </>
